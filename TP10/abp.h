...
/*******************************************************************************
 ...
 Autor : António Manuel Adrego da Rocha    Data : Abril de 2016
...
/*******************************************************************************
 Determina de forma repetitiva a contagem dos elementos pares da arvore fazendo 
 uma trevessia por níveis usando uma fila. Valores de erro: OK, ABP_EMPTY ou NO_MEM.

 Counts all even elements of the tree pointed by proot, making a level-by-level
 traversal of the tree using a queue. Error codes: OK, ABP_EMPTY or NO_MEM.
*******************************************************************************/

int ABPMultSum (PtABPNode proot, int pvalue);
/*******************************************************************************
 Determina de forma repetitiva a soma dos elementos da arvore múltiplos
 de pvalue fazendo uma travessia em profundidade utilizando uma pilha.
 Valores de erro: OK, ABP_EMPTY ou NO_MEM.

 Sums all elements of the tree pointed by proot that are multiple of pvalue, making 
 an in-depth traversal of the tree using a stack. Error codes: OK, ABP_EMPTY or NO_MEM.
*******************************************************************************/

int ABPTotalSum (PtABPNode proot);
/*******************************************************************************
 Determina de forma recursiva a soma de todos os elementos da arvore fazendo
 uma travessia por níveis utilizando uma fila. Valores de erro: OK ou ABP_EMPTY.

 Sums all elements of the tree pointed by proot recursively. Error codes: OK or ABP_EMPTY.
*******************************************************************************/

unsigned int ABPOddCount (PtABPNode proot);
/*******************************************************************************
 Determina de forma recursiva a contagem dos elementos ímpares da arvore.
 Valores de erro: OK ou ABP_EMPTY.

 Counts all odd elements of the tree pointed by proot recursively. Error codes: OK or ABP_EMPTY.
*******************************************************************************/

int ABPEvenOrderSum (PtABPNode proot);
/*******************************************************************************
 Determina de forma repetitiva a soma dos elementos da arvore com número de
 ordem par (segundo + quarto + sexto + etc.) fazendo uma travessia em profundidade
 em ordem utilizando uma pilha. Valores de erro: OK, ABP_EMPTY ou NO_MEM.

 Sums all elements of the tree pointed by proot that have an even order, that is
 the second with the fourth with the sixth and so on, trought a inorder traversal
 using a stack. Error codes: OK, ABP_EMPTY or NO_MEM.
*******************************************************************************/

void ABPOddPrint (PtABPNode proot);
/*******************************************************************************
 Imprime de forma recursiva por ordem crescente os números ímpares armazenados na
 árvore. Valores de erro: OK or ABP_EMPTY.

 Prints recursively all odd elements of the tree pointed by proot by increasing 
 order. Error codes: OK or ABP_EMPTY.
*******************************************************************************/

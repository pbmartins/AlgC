...
/*******************************************************************************
 ...
 Copies the polynomial ppoly returning a new polynomial or NULL if it is not  
 possible to copy the polynomial. Error codes: OK, NO_POLY or NO_MEM.
*******************************************************************************/
...
/*******************************************************************************
 ...
 Creates the symmetrical of polynomial ppoly returning a new polynomial or NULL
 if it is not possible to create the symmetrical. Error codes: OK, NO_POLY or NO_MEM.
*******************************************************************************/

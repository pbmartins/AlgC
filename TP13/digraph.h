/*******************************************************************************
 ...
 Autor : António Manuel Adrego da Rocha    Data : Maio de 2016
...
/*******************************************************************************
 Determina os caminhos mais curtos dos vertices alcançáveis a partir do vertice pv.
...
/*******************************************************************************
 Determina os vertices alcançáveis a partir a partir do vertice pv. Devolve a 
 lista de vertices em pvlist, sendo que a posição 0 da sequência indica o numero
 de vertices alcançáveis. Valores de retorno: OK, NO_DIGRAPH, DIGRAPH_EMPTY, 
 NULL_PTR, NO_VERTEX ou NO_MEM.
 ...
 error codes: OK, NO_DIGRAPH, DIGRAPH_EMPTY, NULL_PTR, NO_VERTEX or NO_MEM.
*******************************************************************************/

int DigraphComplete (PtDigraph pdig, unsigned int *pcomp);
/*******************************************************************************
 Determina se o dígrafo pdig é completo. Coloca 1 em caso afirmativo e 0 no caso
 contrário no parâmetro pcomp. Valores de retorno: OK, NO_DIGRAPH, DIGRAPH_EMPTY
 ou NULL_PTR.
 
 Verifies if digraph/graph pdig is a regular digraph/graph. Stores 1 in 
 affirmative case and 0 otherwise in parameter preg. Returning error codes: OK,
...
/*******************************************************************************
 ...
 criado ou NULL, no caso de inexistência de memória ou do dígrafo/grafo pdig.

*******************************************************************************/

int DigraphStronglyConnected (PtDigraph pdig, unsigned int *pstrong);
/*******************************************************************************
 Verifica se o dígrafo pdig é fortemente conexo. Coloca 1 em caso afirmativo e 0
 no caso contrário no parâmetro pstrong. Valores de retorno: OK, NO_DIGRAPH, 
...
/*******************************************************************************
 Implementa o fecho transitivo do dígrafo pdig no próprio dígrafo. Considere as 
 novas arestas com custo unitário. Valores de retorno: OK, NO_DIGRAPH, 
